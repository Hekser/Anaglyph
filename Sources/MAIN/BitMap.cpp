...
void BitMap::splitInto(unsigned threadsNumber)
{
	int pieceHeight = (int)(height / threadsNumber);
	splitData.push_back(data);
	splitDataHeight.push_back(height - pieceHeight * (threadsNumber - 1));
	...
	for (unsigned i = 1; i < threadsNumber; ++i)
	{
